...
function myFunction63() {
    document.getElementById("myDropdown63").classList.toggle("show");
}
function myFunction64() {
    document.getElementById("myDropdown64").classList.toggle("show");
}
function myFunction65() {
    document.getElementById("myDropdown65").classList.toggle("show");
}
function myFunction66() {
    document.getElementById("myDropdown66").classList.toggle("show");
}
function myFunction67() {
    document.getElementById("myDropdown67").classList.toggle("show");
}
function myFunction68() {
    document.getElementById("myDropdown68").classList.toggle("show");
}
function myFunction69() {
    document.getElementById("myDropdown69").classList.toggle("show");
}
...
function myFunction71() {
    document.getElementById("myDropdown71").classList.toggle("show");
}
function myFunction72() {
    document.getElementById("myDropdown72").classList.toggle("show");
}
function myFunction73() {
    document.getElementById("myDropdown73").classList.toggle("show");
}
function myFunction74() {
    document.getElementById("myDropdown74").classList.toggle("show");
}
function myFunction75() {
    document.getElementById("myDropdown75").classList.toggle("show");
}
function myFunction76() {
    document.getElementById("myDropdown76").classList.toggle("show");
}
function myFunction77() {
    document.getElementById("myDropdown77").classList.toggle("show");
}
